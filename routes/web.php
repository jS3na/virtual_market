...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['check_permission:products.read'])->group(function () {
    ...
    Route::middleware(['check_permission:categories.read'])->group(function () {
    ...
    Route::middleware(['check_permission:roles.read'])->group(function () {
    ...
    Route::middleware(['check_permission:users.read'])->group(function () {
