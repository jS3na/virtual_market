<x-main_layout pageTitle="New Category">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between px-4 py-6">
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 w-full">
            <h1 class="text-2xl md:text-4xl font-semibold text-gray-800">Dashboard / Categories / New</h1>
        </div>
            ...
            <form action="{{ route('categories.add.post') }}" method="post">
                ...
                <div class="mb-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Meats" required />
                        @error('name')
